...
- **Memory**: Knowledge Graph (Neo4j) + Vector Store (Pinecone).
- **Tool Use**: Multi-agent dispatch (Trade-off Matrix, Mermaid generation, Policy Check).
- **Planning**: LangGraph state machine.
- **Output Control**: Guardrails + Reviewer critique loop.
